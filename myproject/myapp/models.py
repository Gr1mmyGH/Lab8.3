...
class Exams(models.Model):
    ...
    student = models.ForeignKey('Students', models.DO_NOTHING, db_column='Student', blank=True, null=True)  # Field name made lowercase.
    subject = models.ForeignKey('Subjects', models.DO_NOTHING, db_column='Subject', blank=True, null=True)  # Field name made lowercase.
...
class Students(models.Model):
    ...
    headman = models.IntegerField(db_column='Headman', blank=True, null=True)  # Field name made lowercase.
...
class Subjects(models.Model):
    ...
    semesters = models.IntegerField(db_column='Semesters', blank=True, null=True)  # Field name made lowercase.
